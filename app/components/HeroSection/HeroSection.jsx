...
export default function HeroSection() {
  return (
    <div className="h-[60vh] lg:h-screen w-full relative">
      ...
      <div className="absolute -top-10 lg:top-10 -left-5 lg:left-10 w-auto h-auto animate-wiggle p-2 lg:p-4 bg-gray-900/50 backdrop-blur-sm rounded-lg shadow-2xl md:block">
        <pre><code className="language-javascript text-[0.6rem] lg:text-xs text-cyan-300"><span className="text-purple-400">const</span> <span className="text-yellow-300">component</span> = () =&gt; (<br />
      ...
      <div className="absolute -bottom-10 lg:bottom-10 -right-20 lg:right-10 w-auto h-auto animate-wiggle p-2 lg:p-4 bg-gray-900/50 backdrop-blur-sm rounded-lg shadow-2xl md:block">
        <pre><code className="language-css text-[0.6rem] lg:text-xs text-cyan-300">.<span className="text-yellow-300">hero</span>&nbsp;&#123;<br />
