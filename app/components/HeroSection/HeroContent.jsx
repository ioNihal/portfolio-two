...
const titles = ['Frontend Developer', 'Backend ~Developer', 'Humble Hoooooooman', 'Freshhhh ~Graaduat']
...
export default function HeroContent() {
    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-center gap-[0.8em] lg:gap-[1.5em]">
            ...
            <h2 className="text-md lg:text-3xl text-white/70 font-semibold">I'm a <span ref={titleRef} className="text-indigo-500 inline-block font-mono">{title}</span></h2>
