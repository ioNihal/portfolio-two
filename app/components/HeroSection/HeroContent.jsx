    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-center gap-[0.8em] lg:gap-[1.5em]">
            ...
            <div className="flex justify-between gap-[1em] *:py-2 lg:*:py-3 *:px-3 lg:*:px-6  *:text-xs lg:*:text-lg *:font-bold *:rounded-sm lg:*:rounded-lg *:cursor-pointer *:transition-colors *:duration-500 *:ease-in-out">
                <button className="text-amber-50 bg-indigo-500 hover:bg-indigo-600 shadow-lg/50 shadow-indigo-500 hover:shadow-indigo-600">View Works</button>
                <button className="text-amber-50 bg-gray-500 hover:bg-gray-600 shadow-lg/50 shadow-gray-500 hover:shadow-gray-600">Resume</button>
            </div>
        </div>
    )
}